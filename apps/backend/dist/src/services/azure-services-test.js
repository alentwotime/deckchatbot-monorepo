...
export async function testAzureServices() {
    ...
    const overall = configStatus.configured &&
 ...
 */
export async function testOpenAIFunctionality() {
 ...
 */
export async function testCosmosFunctionality() {
...
export async function testStorageFunctionality() {
    ...
    try {
        ...
        const uploadResult = await azureStorage.uploadFile('uploads', testContent, 'test-file.txt', 'test-user', {
        ...
        const signedUrl = await azureStorage.generateSignedUrl('uploads', uploadResult.blobName, { permissions: 'r', expiresInMinutes: 30 });
...
//# sourceMappingURL=azure-services-test.js.map